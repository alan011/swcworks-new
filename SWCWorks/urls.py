...
urlpatterns = [
    ...
    url(r'^api/v1/minzhenggangweikaifa/get', getAPIForSWTable2For2019, name='getAPIForSWTable2For2019'),
    url(r'^api/v1/minzhenggangweikaifa/add', addAPIForSWTable2For2019, name='addAPIForSWTable2For2019'),
    url(r'^api/v1/minzhenggangweikaifa/delete', deleteAPIForSWTable2For2019, name='deleteAPIForSWTable2For2019'),
    url(r'^api/v1/minzhenggangweikaifa/update', updateAPIForSWTable2For2019, name='updateAPIForSWTable2For2019'),
